function [R, D] =  doflightr(targetdir,lambdas,lambdaref,N,Cab,Car,Ant,Cbp,Cw,Cdm,LIDFa,LIDFb,LAI,HsD,Crown_Cover,SOLAR_ZENITH,VIEW_ZENITH,VIEW_AZIMUTH,Rs)
